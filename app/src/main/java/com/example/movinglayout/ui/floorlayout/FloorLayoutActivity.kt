...
class FloorLayoutActivity : AppCompatActivity() {
    ...
    private fun addTable(table: Table, layout: ViewGroup) {
        ...
        params.apply {
            width = table.width * columnSize
            height = table.height * columnSize
        }
        ...
        tableView.apply {
            ...
            isSelected = true
            background = ResourcesCompat.getDrawable(resources, R.drawable.item_view_bg, null)
            tag = "table-${table.id}"
    ...
    private fun editTable(table: Table, view: View, layout: ViewGroup) {
